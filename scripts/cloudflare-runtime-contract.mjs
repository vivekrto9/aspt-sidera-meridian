...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "sidera-meridian",
      d1DatabaseName: "sidera-meridian-site",
      r2BucketName: "sidera-meridian-media",
      kvNamespaceName: "LOCAL_SIDERA_MERIDIAN_SESSION_KV",
    },
    preview: {
      workerName: "sidera-meridian-preview",
      d1DatabaseName: "sidera-meridian-preview-site",
      r2BucketName: "sidera-meridian-preview-media",
      kvNamespaceName: "sidera-meridian-preview-session",
    },
    production: {
      workerName: "sidera-meridian-production",
      d1DatabaseName: "sidera-meridian-production-site",
      r2BucketName: "sidera-meridian-production-media",
      kvNamespaceName: "sidera-meridian-production-session",
    },
  },
