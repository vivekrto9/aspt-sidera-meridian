...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "sidera-warm-modern",
      d1DatabaseName: "sidera-warm-modern-site",
      r2BucketName: "sidera-warm-modern-media",
      kvNamespaceName: "LOCAL_SIDERA_WARM_MODERN_SESSION_KV",
    },
    preview: {
      workerName: "sidera-warm-modern-preview",
      d1DatabaseName: "sidera-warm-modern-preview-site",
      r2BucketName: "sidera-warm-modern-preview-media",
      kvNamespaceName: "sidera-warm-modern-preview-session",
    },
    production: {
      workerName: "sidera-warm-modern-production",
      d1DatabaseName: "sidera-warm-modern-production-site",
      r2BucketName: "sidera-warm-modern-production-media",
      kvNamespaceName: "sidera-warm-modern-production-session",
    },
  },
